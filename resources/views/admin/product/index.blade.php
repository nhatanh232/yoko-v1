    ...
    <div id="page-content">
        <div class="panel panel-bordered-primary">
            <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-list" aria-hidden="true"></i> Danh sách sản phẩm</h3>
            </div>
            ...
            <div class="panel-body overflow-hidden">
                ...
                >
                    ...
                    <tr>
                        ...
                        <th data-field="quantity">Số lượng còn</th>
                        <th data-field="unit">Đơn vị</th>
                        <th data-field="price" data-formatter="formatPrice">Giá</th>
                        <th data-field="category.name">Danh mục</th>
